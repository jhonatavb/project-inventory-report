...
class SimpleReport:
    ...
    def generate(products_list):
        company_with_more_products = SimpleReport.get_company_with_more_products(products_list)
        oldest_fabrication_date = SimpleReport.get_product_with_oldest_fabrication_date(products_list)
        nearest_validation_date = SimpleReport.get_product_with_closest_validate_date(products_list)
        return (
